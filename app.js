...
(function(){
  ...
  function polish(){
    ...
    // Só remove o modal se ele for literalmente o placeholder fantasma "Modal".
    document.querySelectorAll('.modal, .modal-backdrop, .modal-overlay, [role="dialog"]').forEach(el => {
